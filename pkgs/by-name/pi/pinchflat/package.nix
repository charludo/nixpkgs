...
beamPackages.mixRelease rec {
  ...
  src = fetchFromGitHub {
    ...
    repo = "pinchflat";
    rev = "v${version}";
    hash = "sha256-MF5bqebinGMN867A9WPO8se1ntaSFv/2g+Ed8L3E3VM=";
  };
  ...
  postBuild = ''
    ...
    ln -s "${tailwindcss}/bin/tailwindcss" "_build/tailwind-linux-x64"
    ln -s "${esbuild}/bin/esbuild" "_build/esbuild-linux-x64"
